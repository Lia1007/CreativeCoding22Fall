...
public class Maxident_Player extends PApplet {
...
class Particle {
  ...
  Particle() {
    ...
    acceleration = new PVector(random(-0.0002f, -0.02f), 0.02f);
  ...
  public void settings() {  size(1181, 1574); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Maxident_Player" };
    if (passedArgs != null) {
